	...
	<div class="dropdown">
		<div class="dropdown-wrapper arrow-up-left">
			...
			<ul class="categories-list">
				...
				<li class="cat-item cat-item-7"><a href="{{ route('month_place_cate_by_event',$v_info -> id )}}" >{{ $v_info -> name }}</a>
				</li>
				@endforeach
			</ul>
	...
	<div class="dropdown">
		<div class="dropdown-wrapper arrow-up-left">
			...
			<ul class="categories-list">
				...
				<li class="cat-item cat-item-7"><a href="{{ route('place_cate_by_event',$v_info -> id )}}" >{{ $v_info -> name }}</a>
				</li>
				@endforeach
			</ul>
