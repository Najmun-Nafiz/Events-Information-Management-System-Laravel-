...
<ul class="navbtns">
<li>
<a href="{{ route('prev_post',$info -> id) }}" rel="prev">Previous post</a>							</li>
<li>
	<a href="{{ route('next_post',$info -> id) }}" rel="next">Next post</a>							</li>
</ul>
...
<section class="box" style="margin-top: 50px;border: 2px solid #F59E00;">
	<table class="table noBorder mng">
		<tbody>
			...
			<tr>
				...
				<td>
					<h2>Official Links</h2> <a href="{{ route('back') }}" onclick="attendNew(this ,'orgdetailswebsite_interest');" class="btn btn-xs btn-default x-ob-ow ">Website</a>

					<a href="{{ route('contact_us') }}" onclick="attendNew(this ,'orgdetailscontact_interest');" class="btn btn-xs btn-default x-ob-cd">Contacts </a>
				</td>
			</tr>
		</tbody>
	</table>
 ...
 <form class="row" method="post" action="{{ route('comment') }}" enctype="multipart/form-data" style="margin-left: 25px;">
                                ...
                                <div class="col-md-10">
              						...
              						<div class="form-group">
                                        <textarea class="form-control content" name="description" placeholder="Comments" cols="7" rows="2" required style="width: 70%;"></textarea>
                                    </div>
