                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.dashboard.place.update',$info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
									...
									<div class="form-group">
                                        <label style="font-size: 16px;">Place-Name</label> 
                                    ...
                                    <a class="col-md-5 btn btn-primary btn-block" href="{{ route('admin.dashboard.place.index') }}" style="background-color: red; color: #fff;border-color: #007bff;display: inline-block;font-size: 16.5px;margin-top: -2px; ">Back To Home</a>
