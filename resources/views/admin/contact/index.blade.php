                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 150px;">
                                    ...
                                    <span class="alert-success" style="color: black;padding: 3px;">Replied</span>
                                    
                                    @else
                                    <span class="alert-danger" style="color: black;padding: 3px;">Not-Reply</span>
                                ...
                                <td>
                                    ...
                                    @if($v_info -> status == true)
                                    <a href="{{ route('admin.dashboard.contact.unactive',$v_info->id) }}" style="background-color: #908f8f;padding: 4px 7px;margin-right: 5px; border-radius: 3px;">
                                        
                                        <i class="zwicon-close-circle" style="color: white;font-size: 18px;"></i>
                                    </a>
                                    @else
                                    <a href="{{ route('admin.dashboard.contact.active',$v_info->id) }}" style="background-color: green;padding: 4px 7px;margin-right: 5px; border-radius: 3px;margin-top: 5px;">
                                        <i class="zwicon-checkmark-circle" style="color: white;font-size: 18px;"></i>
                                    </a>
                                    @endif

                                    <a href="{{route('admin.dashboard.contact.destroy',$v_info->id)}}" class="btn btn-danger btn-sm"><i class="zwicon-folder-delete" style="color: white;font-size: 18px;"></i></a>
                                </td>
