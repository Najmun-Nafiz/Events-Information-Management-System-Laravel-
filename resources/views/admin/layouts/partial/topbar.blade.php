...
<header class="header">
                ...
                <div class="logo d-none d-sm-inline-flex">
                    <a href="{{ route('admin.dashboard') }}"><img src="{{asset('front/wp-content/themes/pinthis/images/logo2.png')}}" alt="PinThis Theme Preview" style="height: 40px;width: 30px;"><span style="position:absolute;margin-left: 20px;font-size: 20px;margin-top: 15px;">Pin Box</span></a>
                </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                            ...
                            <div class="listview listview--hover">
                                <a href="#" class="listview__item">
                                    <img src="{{asset('back/demo/img/profile-pics/1.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('back/demo/img/profile-pics/2.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('back/demo/img/profile-pics/3.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('back/demo/img/profile-pics/4.jpg')}}" class="avatar-img" alt="">
                                ...
                                <a href="#" class="listview__item">
                                    <img src="{{asset('back/demo/img/profile-pics/5.jpg')}}" class="avatar-img" alt="">
