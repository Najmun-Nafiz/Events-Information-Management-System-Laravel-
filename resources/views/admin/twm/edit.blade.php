...
<section class="content">
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Update-Today_Week_Month</h4>
                            <div class="col-md-6">
                            </div>
                            ...
                            <form class="row" method="post" action="{{ route('admin.dashboard.twm.update', $info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="name" name="name" required value="{{ $info -> name }}">
                                    </div>
