                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.dashboard.aboutus.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Dhaka Office" name="dhaka_offiece" required>
                                    </div>


		                            <div class="form-group">
                                        <label style="font-size: 16px;">Chittagong Offiece</label>
                                        <input type="text" class="form-control" placeholder="Chittagong Offiece" name="chittagong_offiece" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Rajshahi Offiece</label>
                                        <input type="text" class="form-control" placeholder="Rajshahi Offiece" name="rajshahi_offiece" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Helpdesk</label>
                                        <input type="email" class="form-control" placeholder="Helpdesk" name="helpdesk" required>
                                    </div>
