                ...
                <div class="content__inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="row" method="post" action="{{ route('admin.dashboard.event.update',$info -> id) }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-10">
									...
									<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Title" name="title" value="{{ $info -> title }}" required>
                                    </div>
                                    ...
                                    <div class="form-group mb-0" style="padding-bottom: 30px;">
		                                ...
		                                <select class="form-control" name = "category_id">
		                                    ...
		                                    @foreach($category as $v_info)
		                                    	<option {{ $v_info -> id == $info->category->id ? 'selected' : '' }} value = "{{$v_info -> id}}" style="background-color: #312b2b;">
		                                    		{{$v_info -> name}}
		                                    	</option>
		                                    @endforeach
		                            ...
		                            <div class="form-group mb-0" style="padding-bottom: 30px;">
		                                ...
		                                <select class="form-control" name = "place_id">
		                                    ...
		                                    @foreach($place as $v_info)
		                                    	<option {{ $v_info -> id == $info->place->id ? 'selected' : '' }} value = "{{$v_info -> id}}" style="background-color: #312b2b;">
		                                    		{{$v_info -> name}}
		                                    	</option>
		                                    @endforeach
		                            ...
		                            <div class="form-group mb-0" style="padding-bottom: 30px;">
		                                ...
		                                <select class="form-control" name = "month_id">
		                                    ...
		                                    @foreach($date as $v_info)
		                                    	<option {{ $v_info -> id == $info->month->id ? 'selected' : '' }} value = "{{$v_info -> id}}" style="background-color: #312b2b;">
		                                    		{{$v_info -> name}}
		                                    	</option>
		                                    @endforeach
		                            ...
		                            {{-- <div class="form-group mb-0" style="padding-bottom: 30px;">
		                                ...
		                                <select class="form-control" name = "category_id">
		                                    ...
		                                    @foreach($category as $v_categories)
		                                    	<option {{ $v_categories -> id == $date->category->id ? 'selected' : '' }} value = "{{$v_categories -> id}}" style="background-color: #312b2b;">
		                                    		{{$v_categories -> name}}
		                                    	</option>
		                                    @endforeach
		                            ...
		                            <div class="form-group">
                                        ...
                                        <input type="text" id="datetimepicker1" class="form-control" placeholder="Date" value="{{ $info -> date }}" name="date" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="datetimepicker2" class="form-control" placeholder="Time" value="{{ $info -> time }}" name="time" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Enry Fee</label>
                                        <input type="text" class="form-control" placeholder="Enry Fee" name="entry_fee" value="{{ $info -> entry_fee }}" required>
                                    </div>


                                    <div class="form-group">
                                        <label style="font-size: 16px;">Participant</label>
                                        <input type="text" class="form-control" placeholder="Participant" name="participant" value="{{ $info -> participant }}" required>
                                    </div>


                                    <div class="form-group">
                                        <label style="font-size: 16px;">Eddition</label>
                                        <input type="text" class="form-control" placeholder="Eddition" name="eddition" value="{{ $info -> eddition }}" required>
                                    </div>

                                    <div class="form-group">
                                        <label style="font-size: 16px;">Short Description</label>
                                        <textarea class="form-control" name="short_description" placeholder="Description" cols="7" rows="5" required>{{ $info -> short_description }}</textarea>
                                    </div>
