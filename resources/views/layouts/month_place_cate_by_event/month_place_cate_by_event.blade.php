...
<div class="container fluid">
	...
	<div class="category-title">
		...
		<h3 class="title-3 border-color-1" style="text-align: center;font-size: 26px;font-style: italic;color: #f9e70f;margin-top: 20px;margin-bottom: 100px;">{{ $v_info -> name }} <span style="color: white;"> Events in </span> <span style="color: #7adc3d;">{{ $info -> name }}</span> <span style="color: white;"> at </span> <span style="color: #00ffc4;">{{ $place_name -> name }}</span></h3>
		@endforeach
	...
	<div class="dropdown">
		<div class="dropdown-wrapper arrow-up-left">
			...
			<ul class="categories-list">
				...
				<li class="cat-item cat-item-7"><a href="{{ route('home.month_place_cate_by_event',$v_info -> id )}}" >{{ $v_info -> name }}</a>
				</li>
				@endforeach
			</ul>
	...
	<div class="dropdown">
		<div class="dropdown-wrapper arrow-up-left">
			...
			<ul class="categories-list">
				...
				<li class="cat-item cat-item-7"><a href="{{ route('home.place_cate_by_event',$v_info -> id )}}" >{{ $v_info -> name }}</a>
				</li>
				@endforeach
			</ul>
