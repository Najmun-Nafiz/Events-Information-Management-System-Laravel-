...
<div class="container-fluid">
	...
	<div class="category-title">
		...
		<h3 class="title-3 border-color-1" style="text-align: center;font-size: 26px;font-style: italic;color: #f9e70f;margin-top: 40px;margin-bottom: 100px;">{{ $info -> name }} <span style="color: white;">Events</span></h3>
