...
namespace App\Http\Controllers\Home\Cat_By_Event;
...
class Category_By_EventController extends Controller
{
    public function category_by_event(Request $request,$id)
    {
    	...
    	return view('layouts.category_by_event.category_by_event', compact('info','event','event_all','place','month','twm'));
    }
    ...
    public function place_cate_by_event(Request $request,$id)
    {
        ...
        return view('layouts.place_cate_by_event.place_cate_by_event',compact('info','event','event_all','month','place','category','twm'));
    }
    ...
    public function month_place_cate_by_event(Request $request,$id)
    {
        ...
        return view('layouts.month_place_cate_by_event.month_place_cate_by_event',compact('info','event','event_all','month','place','category','place_name','twm'));
    }
    ...
    public function month_by_event(Request $request,$id)
    {
    	...
    	$info = Date::find($id);
        $category = Category::get()->where('id',$cat_id);
    	return view('layouts.month_by_event.month_by_event',compact('info','event','event_all','month','place','category','twm'));
    }
    ...
    public function place_by_event(Request $request,$id)
    {
    	...
    	return view('layouts.place_by_event.place_by_event',compact('info','event','event_all','month','place','category','month_name','twm'));
    }
